...
namespace MarkupDiff
{
    ...
    public class LineStyle
    {
        ...
        private static  IEnumerable<LineStyle> LoadStyles() 
        {
            ...
            styles.Add(new LineStyle(LineStyleNames.Padding, Color.PeachPuff, Color.Peru, false));
            styles.Add(new LineStyle(LineStyleNames.Ignore, Color.DarkGreen, Color.LightGreen, false));
            styles.Add(new LineStyle(LineStyleNames.LinkingTag, Color.MediumSeaGreen, Color.LightGreen, false));
